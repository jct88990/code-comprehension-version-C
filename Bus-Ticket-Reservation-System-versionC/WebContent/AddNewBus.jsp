	...
	<div class="centerformWrapper col-lg-4 col-md-6 col-sm-12 col-xs-4">
		...
		<div class="centerform col-lg-12 col-md-12 col-sm-12c col-xs-12">
			<form name="myForm" action="AddNewBusFormController"
				...
				<!-- departure time represent the time the bus depart and travel time represent the time needed for travel (HH:MM) (A3) -->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<!-- options for operationDays, only show the character representing the days (A2) -->
					...
					<input type="checkbox" name="OperatingDays5" value="H">Thursday<br />
					<input type="checkbox" name="OperatingDays6" value="F">Friday<br />
					<input type="checkbox" name="OperatingDays7" value="A">Saturday<br />
				</div>
				<div class="form-group">
